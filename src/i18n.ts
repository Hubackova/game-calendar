...
const cs = {
  ...
  overviews: "Přehledy",
  /** Pripona nadpisu stranky: „Říjen 2026 — chystané hry“. */
  headingGames: "chystané hry",
  headingUndated: "hry bez data vydání",
  prevPeriod: "Předchozí",
  nextPeriod: "Další",
  headingSearch: "výsledky hledání",
  yearsLabel: "Rok",
  ...
  exportImage: "Stáhnout",
  exportRunning: "Připravuji obrázek…",
  exportFailed: "Obrázek se nepodařilo vytvořit",
...
const en: typeof cs = {
  ...
  overviews: "Overviews",
  headingGames: "upcoming games",
  headingUndated: "games without a release date",
  prevPeriod: "Previous",
  nextPeriod: "Next",
  ...
  exportRunning: "Preparing the image…",
